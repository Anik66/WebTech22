    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="password" placeholder="Enter  3 digit password" >
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input type="password" name="Confirm-password" placeholder="Confirm  3 digit password">
                </td>
            </tr>
            ...
            <td for="address">Address</td>
                ...
                <td>
                    <textarea input type="text" id="address" name="address" placeholder="Doctor's Address" rows="3" cols="20"></textarea>
                </td>
            </tr>
